...
public class FilmActor extends TableImpl<FilmActorRecord> {
    ...
    private static final long serialVersionUID = 398662960;
    ...
    /**
     * The column <code>film_actor.character</code>.
     */
    public final TableField<FilmActorRecord, String> CHARACTER = createField("character", org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");
